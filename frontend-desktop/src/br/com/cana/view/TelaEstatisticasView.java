...
public class TelaEstatisticasView extends JFrame {
    ...
    public TelaEstatisticasView() {
        ...
        // Pega o ano atual do sistema (Ex: vai retornar 2026 agora, e 2027 no ano que
        // vem)
        ...
        cbPeriodo.addActionListener(e -> {
            ...
            if (selecao != null) {
                // Remove tudo que não for número da String (Ex: "2026" fica "2026", e "Todas
                // (2026)" também fica "2026")
        ...
        // Comparador customizado para as colunas de Gols e Cartões (String para
        // Integer)
        java.util.Comparator<Object> comparadorNumerico = (o1, o2) -> {
            int v1 = o1 != null ? (int) Math.round(Double.parseDouble(o1.toString().trim())) : 0;
            int v2 = o2 != null ? (int) Math.round(Double.parseDouble(o2.toString().trim())) : 0;
            return Integer.compare(v1, v2);
        };

        java.util.Comparator<Object> comparadorPorcentagem = (o1, o2) -> {
            int v1 = o1 != null ? (int) Math.round(Double.parseDouble(o1.toString().replace("%", "").trim())) : 0;
            int v2 = o2 != null ? (int) Math.round(Double.parseDouble(o2.toString().replace("%", "").trim())) : 0;
            return Integer.compare(v1, v2);
        };
    ...
    private void carregarEstatisticas(int temporadaId) {
        ...
        try {
            // Busca as estatísticas da temporada via API
            String json = ApiClient.get("/estatisticas?temporada=" + temporadaId);
            ...
            java.util.List<Object[]> dados = gson.fromJson(json, type);
            ...
            JOptionPane.showMessageDialog(this, "Erro ao carregar estatísticas da API: " + ex.getMessage(),
