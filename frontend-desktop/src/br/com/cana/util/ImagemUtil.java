        ...
        for (int i = 0; i < partes.length; i++) {
            ...
            for (String t : subTokens) {
                if (t.equals("⚽")) {
                    ...
                    sb.append("<td bgcolor='#FFCC00' width='8' height='12' valign='middle'><font size='1'>&nbsp;</font></td>");
                    temEmoji = true;
                } else if (t.equals("🟥")) {
                    sb.append("<td bgcolor='#8B0000' width='8' height='12' valign='middle'><font size='1'>&nbsp;</font></td>");
                    temEmoji = true;
                }
            }
            
            // 🌟 A MÁGICA: Se não tem emoji, cria uma base invisível para a barra não sumir!
            if (!temEmoji) {
                sb.append("<td valign='middle'>&nbsp;&nbsp;&nbsp;</td>");
            }
